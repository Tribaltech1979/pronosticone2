...
function colora(){
    ...
    $(".G1").each(function () {
       if($(this).html() ){
           if($(this).html() == $(this).parents("tr").find(".GC").html()){
               $(this).parents("tr").find(".GC").css('background-color', '#99FF33');
           }
       } 
    });
    $(".G2").each(function () {
       if($(this).html() ){
           if($(this).html() == $(this).parents("tr").find(".GH").html()){
               $(this).parents("tr").find(".GH").css('background-color', '#99FF33');
           }
       } 
    });
    ////segno
